...
from engine.cpr_atr_result import BacktestResult
...
from engine.cpr_trade_simulator import simulate_strategy_trade
...
BacktestResult.default_db_factory = staticmethod(lambda: get_db())
...
class CPRATRBacktest:
    ...
    def _simulate_trade(self, **kwargs: Any) -> TradeResult:
        """Compatibility seam for tests and strategy variants; implementation lives in helper."""
        return simulate_strategy_trade(
            params=self.params,
